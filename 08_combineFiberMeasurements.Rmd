####################################################################################
#Name:         #08_combineFiberMeasurements.Rmd

#Last updated: #2020-05-05

#Description:  #This script pulls in the .csvs in 04_DiffusionMeasurements
               #Each participant has a .csv for left, right, commissural
               #These are combined into a single (final) .csv in txt_outputs
 
####################################################################################

```{r setup}

#list required ibraries
...
csvs <- list.files(path='/projects/ncalarco/thesis/SPINS/Slicer/data/08_registered/04_DiffusionMeasurements', pattern="*.csv") #have 1335
